...
from data_transfer.module_views.fzxy_views import get_department_data_view, get_tradition_class_data_view, \
    get_user_map_data_view, get_course_class_data_view, get_choose_course_data_view
